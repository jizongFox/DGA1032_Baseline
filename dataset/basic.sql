select cast(basetable.equvalent_slice_number as integer ) as equvalent_slice_number,avg (basetable.class1)
from (
...
group by cast(basetable.equvalent_slice_number as integer )
