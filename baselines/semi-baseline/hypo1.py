...
#     '/Users/jizong/workspace/DGA1032_grid_search/checkpoint/model_0.6664_split_0.050.pth', map_location=map_location))
...
for iteration in tqdm(range(10000)):
    ...
    # if (iteration ) % 200 == 0:
    #     unlabeled_ious = evaluate_iou(unlabeled_dataLoader, neural_net)
    #     val_ious = evaluate_iou(val_loader, neural_net)
    ...
    #
    #         pd.DataFrame(ious_tables).to_csv(os.path.join('results',filename,'ious_showmyown_results.csv'),header=None)
